# Contributing to atomictech projects

> This document is based on the DurandalProject contribution guidelines: [Durandal](https://github.com/DurandalProject/about/blob/master/CONTRIBUTING.md)
...
As contributors and maintainers of atomictech projects, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.

Communication through any atomictech channels (GitHub, Gitter, mailing lists, Google+, Twitter, etc.) must be constructive and never resort to personal attacks, trolling, public or private harassment, insults, or other unprofessional conduct.

We promise to extend courtesy and respect to everyone involved in this project regardless of gender, gender identity, sexual orientation, disability, age, race, ethnicity, religion, or level of experience. We expect anyone contributing to atomictech projects to do the same.

If any member of the community violates this code of conduct, the maintainers of the atomictech projects may take action, removing issues, comments, and PRs or blocking accounts as deemed appropriate.

If you are subject to or witness unacceptable behavior, or have any other concerns, please signal it on our main Gitter channel.

## <a name="question"></a> Got a Question or Problem?

If you have questions about how to use any atomictech project library, please direct these to the Gitter Channels or StackOverflow.
